...
#dataset
train_file = 'D:\Post\KGRL\KGRL-main\processed\laptop_train.npy'
...
def generate_text(key,text):
    ...
    prompt=f"""According to the following sentiment elements definition:
              ...
              “LAPTOP#GENERAL”, “LAPTOP#OPERATION_PERFORMANCE”, “LAPTOP#DESIGN_FEATURES”, “LAPTOP#QUALITY”, “LAPTOP#MISCELLANEOUS”, “LAPTOP#USABILITY”, “SUPPORT#QUALITY”, 
              “LAPTOP#PRICE”,“COMPANY#GENERAL”, “BATTERY#OPERATION_PERFORMANCE”.
...
#构造预测结果
asp2id = {"LAPTOP#GENERAL": 1, "LAPTOP#OPERATION_PERFORMANCE": 2, "LAPTOP#DESIGN_FEATURES": 3, "LAPTOP#QUALITY": 4, "LAPTOP#MISCELLANEOUS": 5, 
          "LAPTOP#USABILITY": 6, "SUPPORT#QUALITY": 7, "LAPTOP#PRICE": 8, "COMPANY#GENERAL": 9, "BATTERY#OPERATION_PERFORMANCE": 10}
sen2id ={"negative":0,"neutral":1,"positive":2}
data = np.load("lap_pre.npy",allow_pickle=True)


#print(generate_text(key,train_sen[1167]))
